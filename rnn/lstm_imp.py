...
class LSTM_IMPL(object):
    def __init__(self, log_path):
        ...
        self.__time_step_column = 'flagtime'
    ...
    def excute(self, path, train=True):
        data_parse = data_frame(path, self.__batch_size, self.__time_step, self.__feature_col, self.__label_col, self.__time_step_column)
