...
class LSTM_IMPL(object):
    ...
    def excute(self, path):
        ...
        print('        actual-T    |     actual-F')
        print(' -----------------------------------')
        print('pred-P|       {}    |         {}    |'.format(tp, fp))
        print(' -----------------------------------')
        print('pred-N|       {}    |         {}    |'.format(tn, fn))
        print(' -----------------------------------')
        logging.info('recall=tp/(tp+fn):{},precesion=tp/(tp+fp):{}'.format(tp / (tp + fn), tp / (tp + fp)))
        logging.info('        actual-T    |     actual-F')
        logging.info(' -----------------------------------')
        logging.info('pred-P|       {}    |         {}    |'.format(tp, fp))
        logging.info(' -----------------------------------')
        logging.info('pred-N|       {}    |         {}    |'.format(tn, fn))
        logging.info(' -----------------------------------')
